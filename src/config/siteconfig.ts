...
export const siteConfig = {
  name: 'ClimateX', // Fixed spelling typo
  url: 'http://localhost:3000', // Added the missing url property to prevent Next.js build crash
  title: 'ClimateX: Real-Time Climate Information', // Fixed spelling typo here too
  description:
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: `${siteConfig.url}/${siteConfig.ogImage}`, // Added slash for path safety
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: [`${siteConfig.url}/${siteConfig.ogImage}`], // Added slash for path safety
  },
